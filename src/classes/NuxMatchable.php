...
abstract class NuxMatchable extends NuxScriptable {
    ...
    public function __construct(string $name, string $text, string $matching, string $scriptPath, bool $enabled = true, bool $whole_words = true, bool $case_sensitive = true) {
